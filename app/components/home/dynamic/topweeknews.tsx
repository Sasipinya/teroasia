...
function TopWeekNews({ data }: { data: any }) {
                        ...
                        <SwiperSlide key={index}>
                            <div className=" rounded-md   border  shadow-md">
                                ...
                                <div className="px-3 py-4">
                                    <p >
                                        <Link href={`/news/${item.news_id}`} className='2xl:text-lg text-md text-gray-600 hover:text-red-700 line-clamp-2 2xl:line-clamp-1' >{item.news_title}</Link>
                                    </p>
                                </div>
