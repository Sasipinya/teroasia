...
const ShowHeroesMobile = ({ showheroes_signature }: { showheroes_signature: string }) => {

  useEffect(() => {
    const adContainerId = 'showheroes_mobile';
  ...
  return <div id="showheroes_mobile"></div>;

}

export default ShowHeroesMobile;